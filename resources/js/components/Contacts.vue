<template>
  <div>
    ...
    <form action="#" @submit.prevent="edit ? updateContact(contact.id) : createContact()">
      ...
      <div class="form-group">
        <label>Phone</label>
        <input v-model="contact.phone" type="text" name="phone" class="form-control" required>
      </div>
      <div class="form-group">
        <button v-show="!edit" type="submit" class="btn btn-block btn-primary">New Contact</button>
        <button v-show="edit" type="submit" class="btn btn-block btn-primary">Update Contact</button>
      </div>
    </form>
    <hr>
    <h1>Contacts</h1>
